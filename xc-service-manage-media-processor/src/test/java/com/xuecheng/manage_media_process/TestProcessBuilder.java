...
//        processBuilder.command("java","-jar","f:/xc-service-manage-course.jar");
    ...
    public void testFFmpeg(){
        ...
        command.add("D:\\tools\\ffmpeg-20180227-fa0c9d6-win64-static\\bin\\ffmpeg.exe");
        command.add("-i");
        command.add("E:\\ffmpeg_test\\lucene.avi");
        command.add("-y");
        //覆盖输出文件
        command.add("-c:v");
        command.add("libx264");
        ...
        command.add("-r");
        command.add("18");
        command.add("E:\\ffmpeg_test\\lucene.mp4");
    ...
    public void testProcessMp4(){
        ...
        //ffmpeg的路径
        String ffmpeg_path = "D:\\tools\\ffmpeg-20180227-fa0c9d6-win64-static\\bin\\ffmpeg.exe";
        //video_path视频地址
